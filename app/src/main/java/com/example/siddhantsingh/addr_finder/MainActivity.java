package com.example.siddhantsingh.addr_finder;
...
import static com.example.siddhantsingh.addr_finder.Constants.USE_ADDRESS_NAME;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        infoText.setText("Latitude: " + address.getLatitude() + "\n" +
                                ...
                                address.getPostalCode() + "\n" + address.getCountryName());                         //resultData.getString(Constants.RESULT_DATA_KEY));
                    }
                });
            }
            else {
